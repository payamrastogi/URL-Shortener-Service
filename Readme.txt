...
- Extract zip file named troops.zip
- Change the extension .txt of file named "GetTroops-1.0-jar-with-dependencies.txt" to .jar
- On the terminal/command prompt navigate to the folder where you have extracted
	the troops.zip
